...
config :project, ProjectWeb.Endpoint,
  ...
  live_view: [signing_salt: "J9OPxDKV"]
...
config :project, Project.Mailer, adapter: Swoosh.Adapters.Local
...
config :surface, :components, [
  {Surface.Components.Form.ErrorTag, default_translator: {ProjectWeb.ErrorHelpers, :translate_error}}
]

config :tailwind,
  version: "3.1.6", default: [
  args: ~w(
